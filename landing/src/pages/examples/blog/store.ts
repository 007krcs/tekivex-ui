...
function seedPosts(): BlogPost[] {
  ...
  const posts: BlogPost[] = [
    ...
    },
    {
      ...
      title: 'Design tokens that scale across 116 components',
      ...
      blocks: [
        { id: blockId(), type: 'paragraph', text: 'We rewrote our token system three times before it stuck. Here\'s the version that survived contact with 116 components and four themes.' },
