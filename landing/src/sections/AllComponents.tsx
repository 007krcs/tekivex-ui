...
const GROUPS: ComponentGroup[] = [
  ...
  {
    emoji: '✨',
    title: 'Holographic (v3.1)',
    desc: '3D-tilt + iridescent foil',
    components: [
      { name: 'HolographicSurface', slug: 'holographic-surface', isNew: true },
      { name: 'HolographicCard', slug: 'holographic-card', isNew: true },
      { name: 'HolographicAvatar', slug: 'holographic-avatar', isNew: true },
      { name: 'HolographicBadge', slug: 'holographic-badge', isNew: true },
      { name: 'HolographicButton', slug: 'holographic-button', isNew: true },
    ],
  },
  {
    emoji: '📝',
