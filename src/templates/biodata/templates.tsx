  ...
  return (
    <Page background="#fff8e7">
      ...
      <div style={{ textAlign: 'center', borderBottom: `0.5mm double ${accent}`, paddingBottom: '4mm' }}>
        <ReligiousHeader religion={data.religion} override={data.religiousMark} blessing={data.blessing} customLogo={data.customReligiousLogo} customLogoLabel={`${data.religion ?? 'Custom'} symbol`} color={accent} size={28} />
...
export function BiodataModernUniversal({ data }: { data: BiodataData }) {
  ...
  return (
    <Page>
      <ReligiousHeader religion={data.religion} override={data.religiousMark} blessing={data.blessing} customLogo={data.customReligiousLogo} customLogoLabel={`${data.religion ?? 'Custom'} symbol`} color={accent} />
...
export function BiodataCompact({ data }: { data: BiodataData }) {
  ...
  return (
    <Page padding={10}>
      <ReligiousHeader religion={data.religion} override={data.religiousMark} blessing={data.blessing} customLogo={data.customReligiousLogo} customLogoLabel={`${data.religion ?? 'Custom'} symbol`} color={accent} size={20} />
  ...
  return (
    <Page background="#fffbf2">
      <div style={{ border: `0.5mm double ${accent}`, padding: '6mm' }}>
        <ReligiousHeader religion={data.religion} override={data.religiousMark} blessing={data.blessing} customLogo={data.customReligiousLogo} customLogoLabel={`${data.religion ?? 'Custom'} symbol`} color={accent} size={26} />
    ...
    <Page padding={0}>
      <div style={{ display: 'flex', minHeight: '100%' }}>
        ...
        <main style={{ flex: 1, padding: '12mm 8mm' }}>
          <ReligiousHeader religion={data.religion} override={data.religiousMark} blessing={data.blessing} customLogo={data.customReligiousLogo} customLogoLabel={`${data.religion ?? 'Custom'} symbol`} color={accent} size={22} />
          <SectionHeading accent={accent} size="sm">Personal</SectionHeading><PersonalSection d={data} accent={accent} />
          <SectionHeading accent={accent} size="sm">Cultural</SectionHeading><CulturalSection d={data} accent={accent} />
          <SectionHeading accent={accent} size="sm">Career</SectionHeading><CareerSection d={data} accent={accent} />
          <SectionHeading accent={accent} size="sm">Family</SectionHeading><FamilySection d={data} accent={accent} />
