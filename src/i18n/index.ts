...
// Brings library coverage to 44 locales toward the v4.0 goal of 70.
// All Monday-first (ISO 8601), all LTR.

// Bulgarian (Bulgaria)
export const bgBG = locale({
  close: 'Затвори',
  cancel: 'Отказ',
  confirm: 'Потвърди',
  save: 'Запази',
  ...
  today: 'Днес',
  dropFiles: 'Пуснете файлове тук или',
  browse: 'Прегледай',
  ...
  rowsSelected: (n) => `${n} ${n === 1 ? 'избран ред' : 'избрани реда'}`,
  // v2.7 optional fields
  firstPage: 'Първа страница',
  lastPage: 'Последна страница',
  previousPage: 'Предишна страница',
  nextPage: 'Следваща страница',
  showingRange: (s, e, total) => `Показани ${s}–${e} от ${total}`,
  ...
  commandSearch: 'Въведете команда или потърсете…',
  noCommandsFound: 'Няма намерени команди',
  closeDrawer: 'Затвори панела',
  fieldRequired: 'Това поле е задължително',
  invalidFormat: 'Невалиден формат',
  minLength: (n) => `Минимум ${n} символа`,
  maxLength: (n) => `Максимум ${n} символа`,
  minValue: (n) => `Минимум ${n}`,
...
export const hrHR = locale({
  ...
  previous: 'Prethodno',
  next: 'Sljedeće',
  pageOf: (page, total) => `Stranica ${page} od ${total}`,
  selectPlaceholder: 'Odaberi...',
  clearSelection: 'Obriši odabir',
  selectDate: 'Odaberi datum',
  today: 'Danas',
  dropFiles: 'Ispustite datoteke ovdje ili',
  browse: 'Pregledaj',
  noData: 'Nema dostupnih podataka',
  sortAscending: 'Uzlazno sortiranje',
  sortDescending: 'Silazno sortiranje',
  filterPlaceholder: 'Filtriraj...',
  exportCsv: 'Izvezi CSV',
  rowsSelected: (n) => `Odabrano ${n} ${n === 1 ? 'redak' : 'redaka'}`,
  // v2.7 optional fields
  firstPage: 'Prva stranica',
  lastPage: 'Posljednja stranica',
  previousPage: 'Prethodna stranica',
  nextPage: 'Sljedeća stranica',
  showingRange: (s, e, total) => `Prikaz ${s}–${e} od ${total}`,
  itemsPerPage: 'Po stranici',
  ...
  commandSearch: 'Upišite naredbu ili pretražite…',
  noCommandsFound: 'Nema pronađenih naredbi',
  closeDrawer: 'Zatvori ploču',
  fieldRequired: 'Ovo polje je obavezno',
  invalidFormat: 'Neispravan format',
  minLength: (n) => `Najmanje ${n} znakova`,
  maxLength: (n) => `Najviše ${n} znakova`,
  minValue: (n) => `Najmanje ${n}`,
...
export const etEE = locale({
  ...
  commandSearch: 'Sisesta käsk või otsi…',
  noCommandsFound: 'Käske ei leitud',
  closeDrawer: 'Sulge paneel',
  fieldRequired: 'See väli on kohustuslik',
  invalidFormat: 'Vigane vorming',
  minLength: (n) => `Vähemalt ${n} tähemärki`,
  maxLength: (n) => `Maksimaalselt ${n} tähemärki`,
  minValue: (n) => `Vähemalt ${n}`,
...
export const fiFI = locale({
  ...
  previous: 'Edellinen',
  next: 'Seuraava',
  pageOf: (page, total) => `Sivu ${page} / ${total}`,
  selectPlaceholder: 'Valitse...',
  clearSelection: 'Tyhjennä valinta',
  selectDate: 'Valitse päivämäärä',
  today: 'Tänään',
  dropFiles: 'Pudota tiedostot tähän tai',
  browse: 'Selaa',
  noData: 'Ei tietoja',
  ...
  exportCsv: 'Vie CSV',
  rowsSelected: (n) => `${n} ${n === 1 ? 'rivi' : 'riviä'} valittu`,
  // v2.7 optional fields
  firstPage: 'Ensimmäinen sivu',
  lastPage: 'Viimeinen sivu',
  previousPage: 'Edellinen sivu',
  nextPage: 'Seuraava sivu',
  showingRange: (s, e, total) => `Näytetään ${s}–${e} / ${total}`,
  ...
  commandSearch: 'Kirjoita komento tai hae…',
  noCommandsFound: 'Komentoja ei löytynyt',
  closeDrawer: 'Sulje paneeli',
  fieldRequired: 'Tämä kenttä on pakollinen',
  invalidFormat: 'Virheellinen muoto',
  minLength: (n) => `Vähintään ${n} merkkiä`,
  maxLength: (n) => `Enintään ${n} merkkiä`,
  minValue: (n) => `Vähintään ${n}`,
...
export const ltLT = locale({
  ...
  commandSearch: 'Įveskite komandą arba ieškokite…',
  noCommandsFound: 'Komandų nerasta',
  closeDrawer: 'Uždaryti skydelį',
  fieldRequired: 'Šis laukas yra privalomas',
  invalidFormat: 'Neteisingas formatas',
  minLength: (n) => `Bent ${n} simbolių`,
  maxLength: (n) => `Ne daugiau kaip ${n} simbolių`,
  minValue: (n) => `Bent ${n}`,
...
export const lvLV = locale({
  ...
  rowsSelected: (n) => `Atlasītas ${n} ${n === 1 ? 'rinda' : 'rindas'}`,
  // v2.7 optional fields
  firstPage: 'Pirmā lapa',
  lastPage: 'Pēdējā lapa',
  previousPage: 'Iepriekšējā lapa',
  nextPage: 'Nākamā lapa',
  showingRange: (s, e, total) => `Rāda ${s}–${e} no ${total}`,
  itemsPerPage: 'Lapā',
  ...
  commandSearch: 'Ievadiet komandu vai meklējiet…',
  noCommandsFound: 'Komandas nav atrastas',
  closeDrawer: 'Aizvērt paneli',
  fieldRequired: 'Šis lauks ir obligāts',
  invalidFormat: 'Nederīgs formāts',
  minLength: (n) => `Vismaz ${n} rakstzīmes`,
  maxLength: (n) => `Ne vairāk kā ${n} rakstzīmes`,
  minValue: (n) => `Vismaz ${n}`,
...
export const skSK = locale({
  ...
  next: 'Ďalšie',
  pageOf: (page, total) => `Strana ${page} z ${total}`,
  selectPlaceholder: 'Vyberte...',
  clearSelection: 'Vymazať výber',
  selectDate: 'Vyberte dátum',
  today: 'Dnes',
  dropFiles: 'Pretiahnite súbory sem alebo',
  browse: 'Prehľadávať',
  noData: 'Žiadne údaje',
  ...
  commandSearch: 'Zadajte príkaz alebo hľadajte…',
  noCommandsFound: 'Žiadne príkazy sa nenašli',
  closeDrawer: 'Zavrieť panel',
  fieldRequired: 'Toto pole je povinné',
  invalidFormat: 'Neplatný formát',
  minLength: (n) => `Minimálne ${n} znakov`,
  maxLength: (n) => `Maximálne ${n} znakov`,
  minValue: (n) => `Minimálne ${n}`,
...
export const slSI = locale({
  ...
  rowsSelected: (n) => `Izbranih ${n} vrstic`,
  // v2.7 optional fields
  ...
  commandSearch: 'Vnesite ukaz ali poiščite…',
  noCommandsFound: 'Ni najdenih ukazov',
  closeDrawer: 'Zapri ploščo',
  fieldRequired: 'To polje je obvezno',
  invalidFormat: 'Neveljavna oblika',
  minLength: (n) => `Najmanj ${n} znakov`,
  maxLength: (n) => `Največ ${n} znakov`,
  minValue: (n) => `Najmanj ${n}`,
  maxValue: (n) => `Največ ${n}`,
  noRows: 'Ni vrstic',
...
export const nbNO = locale({
  ...
  today: 'I dag',
  dropFiles: 'Slipp filer her eller',
  browse: 'Bla gjennom',
  ...
  filterPlaceholder: 'Filtrer...',
  exportCsv: 'Eksporter CSV',
  rowsSelected: (n) => `${n} ${n === 1 ? 'rad' : 'rader'} valgt`,
  // v2.7 optional fields
  firstPage: 'Første side',
  lastPage: 'Siste side',
  previousPage: 'Forrige side',
  nextPage: 'Neste side',
  showingRange: (s, e, total) => `Viser ${s}–${e} av ${total}`,
  itemsPerPage: 'Per side',
  ...
  commandSearch: 'Skriv en kommando eller søk…',
  noCommandsFound: 'Ingen kommandoer funnet',
  closeDrawer: 'Lukk panel',
  fieldRequired: 'Dette feltet er påkrevd',
  invalidFormat: 'Ugyldig format',
  minLength: (n) => `Minst ${n} tegn`,
  maxLength: (n) => `Maks ${n} tegn`,
  minValue: (n) => `Minst ${n}`,
  maxValue: (n) => `Maks ${n}`,
  noRows: 'Ingen rader',
...
export const LOCALES = {
  ...
  'pa-IN': paIN,
  'ur-PK': urPK,
  // ── Central / Eastern / Northern European (v3.20) ────────────────────────
  'bg-BG': bgBG,
  'hr-HR': hrHR,
  'et-EE': etEE,
  'fi-FI': fiFI,
...
export { getPluralCategory, pluralize } from './plurals';
export type { PluralCategory } from './plurals';
