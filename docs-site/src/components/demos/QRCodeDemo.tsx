  ...
  return (
    <Preview label="Three sizes">
      <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
        <TkxQRCode value="https://ui.tekivex.com" size={80} />
        <TkxQRCode value="https://ui.tekivex.com" size={120} />
        <TkxQRCode value="https://ui.tekivex.com" size={160} />
      </div>
    </Preview>
  );
}
...
export function QRCodeColored() {
  return (
    <Preview label="Custom colour">
      <TkxQRCode value="https://ui.tekivex.com" size={160} color="#4338ca" bgColor="#f1f5f9" />
    </Preview>
  );
}
