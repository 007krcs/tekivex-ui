...
ImageEditor is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxImageEditor.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxImageEditor.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/image-editor).
