---
title: TkxTooltip
description: Tooltip — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---

```tsx
import { TkxTooltip } from 'tekivex-ui';
```

Tooltip is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxTooltip.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxTooltip.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/tooltip).
