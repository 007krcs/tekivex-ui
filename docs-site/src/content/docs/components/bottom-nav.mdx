...
BottomNav is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxBottomNav.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxBottomNav.tsx).
