...
description: 'Indian-address input: type a 6-digit PIN for India Post auto-fill, or use the cascading Country → State → District → Sub-district picker (Taluka/Tehsil).'
---
