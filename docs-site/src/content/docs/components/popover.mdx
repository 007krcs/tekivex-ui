---
title: TkxPopover
description: Popover — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---

```tsx
import { TkxPopover } from 'tekivex-ui';
```

Popover is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxPopover.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxPopover.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/popover).
