---
title: TkxTimeline
description: Timeline — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Timeline is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxTimeline.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxTimeline.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/timeline).
