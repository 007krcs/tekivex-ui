---
title: TkxToolbar
description: Toolbar — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Toolbar is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxToolbar.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxToolbar.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/toolbar).
