...
description: QuantumForm — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
QuantumForm is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxQuantumForm.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxQuantumForm.tsx).
