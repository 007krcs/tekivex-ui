---
title: TkxTag
description: Tag — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Tag is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxTag.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxTag.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/tag).
