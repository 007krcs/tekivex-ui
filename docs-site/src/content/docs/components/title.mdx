---
title: TkxTitle
description: Title — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
The implementation lives at [`src/components/TkxTypography.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxTypography.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/title).
