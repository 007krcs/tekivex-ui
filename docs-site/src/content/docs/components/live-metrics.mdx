...
LiveMetrics is part of the tekivex-ui library. Every component is self-tested
...
The implementation lives at [`src/components/TkxLiveMetrics.tsx`](https://www.tekivex.com/ui).
...
> see the [legacy demo site](https://www.tekivex.com/ui/#/components/live-metrics).
