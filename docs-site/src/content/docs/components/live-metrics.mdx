---
title: TkxLiveMetrics
description: LiveMetrics — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
LiveMetrics is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxLiveMetrics.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxLiveMetrics.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/live-metrics).
