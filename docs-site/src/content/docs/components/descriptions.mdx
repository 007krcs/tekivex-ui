...
import { DescriptionsBasic, DescriptionsBordered, DescriptionsVertical } from '../../../components/demos/DescriptionsDemo';

<DescriptionsBasic client:load />
...
<DescriptionsBordered client:load />
...
<DescriptionsVertical client:load />
