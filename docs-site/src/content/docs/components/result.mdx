...
Result is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxResult.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxResult.tsx).
