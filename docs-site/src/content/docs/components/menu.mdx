---
title: TkxMenu
description: Menu — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---

```tsx
import { TkxMenu } from 'tekivex-ui';
```

Menu is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxMenu.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxMenu.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/menu).
