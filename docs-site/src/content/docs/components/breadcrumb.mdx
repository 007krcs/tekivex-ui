---
title: TkxBreadcrumb
description: Breadcrumb — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Breadcrumb is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxBreadcrumb.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxBreadcrumb.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/breadcrumb).
