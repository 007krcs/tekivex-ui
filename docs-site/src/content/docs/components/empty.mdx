---
title: TkxEmpty
description: Empty — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Empty is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxEmpty.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxEmpty.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/empty).
