---
title: TkxSpin
description: Spin — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Spin is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxSpin.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxSpin.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/spin).
