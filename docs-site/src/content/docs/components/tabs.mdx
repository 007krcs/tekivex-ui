---
title: TkxTabs
description: Tabs — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---

```tsx
import { TkxTabs } from 'tekivex-ui';
```

Tabs is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxTabs.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxTabs.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/tabs).
