...
import { CommandPaletteBasic } from '../../../components/demos/CommandPaletteDemo';

<CommandPaletteBasic client:load />
...
[`src/components/TkxCommandPalette.tsx`](https://www.tekivex.com/ui)
