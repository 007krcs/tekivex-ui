---
title: TkxSegmented
description: Segmented — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Segmented is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxSegmented.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxSegmented.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/segmented).
