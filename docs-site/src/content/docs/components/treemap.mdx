...
import { TreemapBasic, TreemapNested } from '../../../components/demos/TreemapDemo';

<TreemapBasic client:load />
...
[`src/components/TkxTreemap.tsx`](https://www.tekivex.com/ui)
