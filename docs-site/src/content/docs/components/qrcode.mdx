---
title: TkxQRCode
description: QRCode — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
QRCode is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxQRCode.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxQRCode.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/qrcode).
