---
title: TkxAvatar
description: Avatar — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Avatar is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxAvatar.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxAvatar.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/avatar).
