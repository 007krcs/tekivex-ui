...
import { ModalBasic, ModalSizes } from '../../../components/demos/ModalDemo';

## Live demo

<ModalBasic client:load />
...
[`src/components/TkxModal.tsx`](https://www.tekivex.com/ui)
