...
import { GaugeBasic, GaugeThresholds, GaugeTicks } from '../../../components/demos/GaugeDemo';

<GaugeBasic client:load />
...
## Ticks and custom range

<GaugeTicks client:load />
...
[`src/components/TkxGauge.tsx`](https://www.tekivex.com/ui)
