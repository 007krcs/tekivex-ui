---
title: TkxAppBar
description: AppBar — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
AppBar is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxAppBar.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxAppBar.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/app-bar).
