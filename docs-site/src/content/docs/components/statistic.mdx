---
title: TkxStatistic
description: Statistic — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Statistic is part of the 78-component tekivex-ui library. Every component is
...
|---|---|---|---|
| `title` | `string; value: number \| string; prefix?: ReactNode; suffix?: ReactNode` | yes |  |
...
The implementation lives at [`src/components/TkxStatistic.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxStatistic.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/statistic).
