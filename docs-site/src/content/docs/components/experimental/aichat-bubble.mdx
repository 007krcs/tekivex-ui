...
The implementation lives at [`src/components/TkxAIChatBubble.tsx`](https://ui.tekivex.com).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/aichat-bubble).
