---
title: TkxAffix
description: Affix — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---

```tsx
import { TkxAffix } from 'tekivex-ui';
```

Affix is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxAffix.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxAffix.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/affix).
