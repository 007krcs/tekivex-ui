---
title: TkxProgress
description: Progress — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Progress is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxProgress.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxProgress.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/progress).
