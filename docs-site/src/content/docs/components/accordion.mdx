---
title: TkxAccordion
description: Accordion — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---

```tsx
import { TkxAccordion } from 'tekivex-ui';
```

Accordion is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxAccordion.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxAccordion.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/accordion).
