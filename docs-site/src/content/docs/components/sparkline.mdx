...
import { SparklineBasic, SparklineVariants, SparklineSmooth } from '../../../components/demos/SparklineDemo';

<SparklineBasic client:load />
...
<SparklineVariants client:load />

## Smoothing and points

<SparklineSmooth client:load />
...
[`src/components/TkxSparkline.tsx`](https://www.tekivex.com/ui)
