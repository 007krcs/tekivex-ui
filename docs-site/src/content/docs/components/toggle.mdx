---
title: TkxToggle
description: Toggle — accessible React component from tekivex-ui. Variants, props, and accessibility notes.
---
...
Toggle is part of the 78-component tekivex-ui library. Every component is
...
The implementation lives at [`src/components/TkxToggle.tsx`](https://github.com/007krcs/tekivex-ui/blob/master/src/components/TkxToggle.tsx).
...
> see the [legacy demo site](https://ui.tekivex.com/#/components/toggle).
