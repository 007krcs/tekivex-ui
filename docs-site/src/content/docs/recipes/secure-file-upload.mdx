...
description: Verify uploads by their real magic-byte signature, not the Content-Type header — defends against polyglots, spoofing, and double-extension tricks.
---
