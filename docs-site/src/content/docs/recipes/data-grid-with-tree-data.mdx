...
description: Render an org chart, file-system view, or accounts hierarchy as a sortable, editable grid with disclosure carets and indented children. v3.19 — treegrid ARIA built-in.
---
